...
import "flowbite"; // مهم جداً!
import { useEffect } from "react";

export default function NavBar() {
  return (
    <nav class="bg-gray-50 dark:bg-gray-800 border-gray-200  ">
      <div class="w-full max-w-screen-xl  flex flex-wrap items-center justify-between mx-auto p-4 ps-6 ">
        <div
          class="left  w-1/2 items-center justify-between hidden order-first md:flex sm:w-auto md:order-1"
          id="navbar-search"
        >
          ...
          <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
            <li>
              <a
                href="#"
        ...
        <div className="right flex justify-start items-center w-1/2  order-last">
          <div class="flex md:order-2 order-1">
            <button
              type="button"
          ...
          <div class="max-w-screen-xl   flex flex-wrap items-center justify-between order-2 mx-auto p-4">
            <div class="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
              ...
              >
                <ul class="py-2 font-medium text-4xl" role="none">
                  <li>
                    <a
                      href="#"
                      class="block px-4 py-2 text-2xl text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white"
                      role="menuitem"
                    >
